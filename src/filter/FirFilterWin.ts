...
export interface FilterSpec {
   ...
   /**
   * ID of the window function to be used.<br>
   * @see {@link WindowFunctions.windowFunctionIndex}
   */
   windowFunctionId:         string;

   /**
   * Filter width in samples.<br>
   * Either `width` or `normFirstMinFreq` must be specified.
   */
   width?:                   number;

   /**
   * `normFirstMinFreq` is the normalized frequency of the first minimum of the filter transfer curve.<br>
